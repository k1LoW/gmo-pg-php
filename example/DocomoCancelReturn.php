...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/DocomoCancelReturnInput.php');
	require_once( 'com/gmo_pg/client/tran/DocomoCancelReturn.php');
	
	//入力パラメータクラスをインスタンス化します
	$input = new DocomoCancelReturnInput();/* @var $input DocomoCancelReturnInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new DocomoCancelReturn();/* @var $exec DocomoCancelReturn */
	
	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output DocomoCancelReturnOutput */
...
//DocomoCancelReturn入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/DocomoCancelReturn.php' );