...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/DocomoContinuanceCancelReturnInput.php');
	require_once( 'com/gmo_pg/client/tran/DocomoContinuanceCancelReturn.php');

	//入力パラメータクラスをインスタンス化します
	$input = new DocomoContinuanceCancelReturnInput();/* @var $input DocomoContinuanceCancelReturnInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new DocomoContinuanceCancelReturn();/* @var $exec DocomoContinuanceCancelReturn */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output DocomoContinuanceCancelReturnOutput */
...
//DocomoContinuanceCancelReturn入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/DocomoContinuanceCancelReturn.php' );