...
if( isset( $_POST['submit'] ) ){
	...
	$input = new EntryTranCvsInput();/* @var $input EntryTranCvsInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new EntryTranCvs();/* @var $exec EntryTranCvs */
...
//EntryTranCvs入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/EntryTranCvs.php' );