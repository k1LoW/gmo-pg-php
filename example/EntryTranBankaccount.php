...
if( isset( $_POST['submit'] ) ){
	...
	$input = new EntryTranBankaccountInput();/* @var $input EntryTranBankaccountInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new EntryTranBankaccount();/* @var $exec EntryTranBankaccount */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output EntryTranBankaccountOutput */
...
//EntryTranBankaccount入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/EntryTranBankaccount.php' );