...
if( isset( $_POST['submit'] ) ){
	...
	$input = new EntryTranEdyInput();/* @var $input EntryTranEdyInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new EntryTranEdy();/* @var $exec EntryTranEdy */
...
//EntryTranEdy入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/EntryTranEdy.php' );