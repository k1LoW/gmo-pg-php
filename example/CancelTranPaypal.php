...
if( isset($_POST['submit'])) {
	require_once( 'com/gmo_pg/client/input/CancelTranPaypalInput.php');
	require_once( 'com/gmo_pg/client/tran/CancelTranPaypal.php');

	//入力パラメータクラスをインスタンス化します
	$input = new CancelTranPaypalInput();
...
require_once( PGCARD_SAMPLE_BASE . '/display/CancelTranPaypal.php' );
