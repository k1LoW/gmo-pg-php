...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/DocomoContinuanceUserEndInput.php');
	require_once( 'com/gmo_pg/client/tran/DocomoContinuanceUserEnd.php');

	//入力パラメータクラスをインスタンス化します
	$input = new DocomoContinuanceUserEndInput();/* @var $input DocomoContinuanceUserEndInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new DocomoContinuanceUserEnd();/* @var $exec DocomoContinuanceUserEnd */
	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output DocomoContinuanceUserEndOutput */
...
//DocomoContinuanceUserEnd入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/DocomoContinuanceUserEnd.php' );