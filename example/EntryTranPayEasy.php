...
if( isset( $_POST['submit'] ) ){
	...
	$input = new EntryTranPayEasyInput();/* @var $input EntryTranPayEasyInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new EntryTranPayEasy();/* @var $exec EntryTranPayEasy */
...
//EntryTranPayEasy入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/EntryTranPayEasy.php' );