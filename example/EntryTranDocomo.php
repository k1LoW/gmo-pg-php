...
if( isset( $_POST['submit'] ) ){
	...
	$input = new EntryTranDocomoInput();/* @var $input EntryTranDocomoInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new EntryTranDocomo();/* @var $exec EntryTranDocomo */
	
	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output EntryTranDocomoOutput */
...
//EntryTranDocomo入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/EntryTranDocomo.php' );