...
if( isset( $_POST['submit'] ) ){
	...
	$input = new EntryTranBrandtokenInput();/* @var $input EntryTranBrandtokenInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new EntryTranBrandtoken();/* @var $exec EntryTranBrandtoken */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output EntryTranBrandtokenOutput */
...
//EntryTranBrandtoken入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/EntryTranBrandtoken.php' );