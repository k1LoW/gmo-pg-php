...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/ChangeTranBrandtokenInput.php');
	require_once( 'com/gmo_pg/client/tran/ChangeTranBrandtoken.php');

	//入力パラメータクラスをインスタンス化します
	$input = new ChangeTranBrandtokenInput();/* @var $input ChangeTranBrandtokenInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new ChangeTranBrandtoken();/* @var $exec ChangeTranBrandtoken */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output ChangeTranBrandtokenOutput */
...
//ChangeTranBrandtoken入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/ChangeTranBrandtoken.php' );