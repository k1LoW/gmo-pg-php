...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/AuCancelReturnInput.php');
	require_once( 'com/gmo_pg/client/tran/AuCancelReturn.php');
	
	//入力パラメータクラスをインスタンス化します
	$input = new AuCancelReturnInput();/* @var $input AuCancelReturnInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new AuCancelReturn();/* @var $exec AuCancelReturn */
	
	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output AuCancelReturnOutput */
...
//AuCancelReturn入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/AuCancelReturn.php' );