...
if( isset( $_POST['submit'] ) ){
	...
	require_once( 'com/gmo_pg/client/input/EntryExecTranPaidInput.php');
	require_once( 'com/gmo_pg/client/tran/EntryExecTranPaid.php');
	
	//入力パラメータクラスをインスタンス化します
	$input = new EntryExecTranPaidInput();/* @var $input EntryExecTranPaidInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new EntryExecTranPaid();/* @var $exec EntryExecTranPaid */
	
	//パラメータオブジェクトを引数に、実行メソッドを呼びます。
	//正常に終了した場合、結果オブジェクトが返るはずです。
	$output = $exe->exec( $input );/* @var $output EntryExecTranPaidOutput */
...
//EntryExecTranPaid入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/EntryExecTranPaid.php' );