...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/DocomoSalesInput.php');
	require_once( 'com/gmo_pg/client/tran/DocomoSales.php');
	
	//入力パラメータクラスをインスタンス化します
	$input = new DocomoSalesInput();/* @var $input DocomoSalesInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new DocomoSales();/* @var $exec DocomoSales */
	
	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output DocomoSalesOutput */
...
//DocomoSales入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/DocomoSales.php' );