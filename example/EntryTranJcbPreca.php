...
if( isset( $_POST['submit'] ) ){
	...
	$input = new EntryTranJcbPrecaInput();/* @var $input EntryTranJcbPrecaInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new EntryTranJcbPreca();/* @var $exec EntryTranJcbPreca */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output EntryTranJcbPrecaOutput */
...
//EntryTranJcbPreca入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/EntryTranJcbPreca.php' );