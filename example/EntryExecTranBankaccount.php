...
if( isset( $_POST['submit'] ) ){
	...
	require_once( 'com/gmo_pg/client/input/EntryExecTranBankaccountInput.php');
	require_once( 'com/gmo_pg/client/tran/EntryExecTranBankaccount.php');
	
	//入力パラメータクラスをインスタンス化します
	$input = new EntryExecTranBankaccountInput();/* @var $input EntryExecTranBankaccountInput */
		...
		$input->setTargetDate($_POST['TargetDate']);
		$input->setRemarks( mb_convert_encoding( $_POST['Remarks'] , 'SJIS' , PGCARD_SAMPLE_ENCODING ) );
		...
		$input->setCheckMode($_POST['CheckMode']);

	
	//API通信クラスをインスタンス化します
	$exe = new EntryExecTranBankaccount();/* @var $exec EntryExecTranBankaccount */
	
	//パラメータオブジェクトを引数に、実行メソッドを呼びます。
	//正常に終了した場合、結果オブジェクトが返るはずです。
	$output = $exe->exec( $input );/* @var $output EntryExecTranBankaccountOutput */
...
//EntryExecTranBankaccount入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/EntryExecTranBankaccount.php' );