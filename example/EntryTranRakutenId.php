...
if( isset( $_POST['submit'] ) ){
	...
	$input = new EntryTranRakutenIdInput();/* @var $input EntryTranRakutenIdInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new EntryTranRakutenId();/* @var $exec EntryTranRakutenId */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output EntryTranRakutenIdOutput */
...
//EntryTranRakutenId入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/EntryTranRakutenId.php' );