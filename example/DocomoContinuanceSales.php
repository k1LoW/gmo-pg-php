...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/DocomoContinuanceSalesInput.php');
	require_once( 'com/gmo_pg/client/tran/DocomoContinuanceSales.php');

	//入力パラメータクラスをインスタンス化します
	$input = new DocomoContinuanceSalesInput();/* @var $input DocomoContinuanceSalesInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new DocomoContinuanceSales();/* @var $exec DocomoContinuanceSales */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output DocomoContinuanceSalesOutput */
...
//DocomoContinuanceSales入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/DocomoContinuanceSales.php' );